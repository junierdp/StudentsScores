...
public class ShowStudentGUI extends javax.swing.JInternalFrame {
    ...
    private void jmiDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jmiDeleteActionPerformed
        ...
        if(rowSelected >= 0){
            ...
            if(confirmJOP == 0){
                Student e = new Student(Integer.parseInt(jtStudents.getValueAt(rowSelected, 0).toString()),
                                                jtStudents.getValueAt(rowSelected, 1).toString(), 
                                                jtStudents.getValueAt(rowSelected, 2).toString(), 
